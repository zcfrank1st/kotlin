...
fun check(expectedName: String, p: KProperty0<*>): String? {
    ...
    try {
        ...
        (p as KProperty0<*>).getDelegate()
        return "Fail: getDelegate() for a local delegated property should fail because it's not supported"
    } catch (e: KotlinReflectionInternalError) { /* ok */ }
